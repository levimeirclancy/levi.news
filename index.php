...
echo "<style>";
	...
	echo ".section-yellow .link-bubble { order-color: rgba(255,204,0,0.08); background: rgba(255,204,0,0.08); } ";
	echo ".section-orange .link-bubble { order-color: rgba(255,127,80,0.08); background: rgba(255,127,80,0.08); } ";
	echo ".section-blue .link-bubble { order-color: rgba(3,37,76,0.08); background: rgba(3,37,76,0.08); } ";
