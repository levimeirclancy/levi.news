...
echo "<style>";
	...
	echo ".section-subheader { font-family: Verdana; background: inherit; font-size: 200%; display: inline-block; transform: rotate(-5deg); font-weight: 700; line-height: 0.9; max-width: 700px; margin: -50px auto; box-shadow: -5px -5px 20px -10px rgba(30,30,30,0.3); } ";
	echo ".section-description { font-family: Verdana; font-size: 120%; display: block; margin: 150px 0 0 0; font-weight: 400; } ";
