...
echo "<style>";
	...
	echo ".section-info { display: block; text-align: left; width: 100%; padding: 50px 10px; margin: 30px 0 30px 0; box-sizing: border-box; color: #f0f0f0; box-shadow: 0 -15px 20px -12px rgba(30,30,30,0.3); border-top: 2px solid #f0f0f0; } ";
