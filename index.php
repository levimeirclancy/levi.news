...
echo "<style>";
	...
	echo ".header-he, .header-en, .header-ja, .header-ku {  margin: 30px; font-family: Courier New; font-weight: 700; } ";
	echo ".header-he { transform: rotate(-12deg); font-size: 260%;  color: rgba(0,0,0,1); display: inline-block; } ";
	echo ".header-en { transform: rotate(9deg);font-size: 250%; margin: color: rgba(50,50,50,1); display: inline-block; } ";
	echo ".header-ja { transform: rotate(-12deg); font-size: 230%; color: rgba(100,100,100,1); display: inline-block; } ";
