...
echo "<style>";
	...
	echo ".link-bubble { color: #222; border-radius: 25px; border: 2px solid #f5f5f5; background: rgba(255,255,255,0.08); padding: 8px 25px; margin: 10px 0; display: inline-block; text-align: center; } ";
