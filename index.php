...
echo "<style>";
	...
	echo ".link-bubble { font-family: Courier New; font-weight: 700; color: #222; border-radius: 25px; border: 2px solid #f5f5f5; color: rgba(255,255,255,0.9); padding: 8px 35px; margin: 10px 0; display: inline-block; text-align: center; text-decoration-style: wavy; } ";
