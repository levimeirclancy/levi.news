...
echo "<div class='section-description width-wrapper'>";
	echo "As a <b>support mentor</b>, I empower adults with cognitive disabilities to build independence and community through strategic activities, personalized coaching, and creative experiences. Our neurodiverse, person-centered <q>urban village</q> is inspired by Kibbutz Kishorit and rooted in Jewish values.";
	echo "</div>";
echo "<span class='body-spacing'></span>";
echo "<span class='body-spacing'></span>";
