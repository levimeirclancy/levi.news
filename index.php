...
echo "<style>";
	...
	echo ".header-he, .header-en, .header-ja, .header-ku {  margin: 90px auto; font-family: Courier New; display: block; font-weight: 700; line-height: 0.9; } ";
	echo ".header-he { transform: rotate(-12deg); font-size: 300%;  color: rgba(0,0,0,1); } ";
	echo ".header-en { transform: rotate(9deg);font-size: 250%; margin: color: rgba(50,50,50,1); } ";
	echo ".header-ja { transform: rotate(-12deg); font-size: 200%; color: rgba(100,100,100,1); } ";
	echo ".header-ku { transform: rotate(9deg);font-size: 230%; color: rgba(150,150,150,1); } ";
