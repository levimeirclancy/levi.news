...
echo "<head>";
echo "<style>";
	echo "body { font-family: Courier New; background: #222; color: #f5f5f5; line-height: 1.4; } ";
	...
	echo "#header-he { font-size: 300%; display: block; transform: rotate(5deg); font-weight: 700; } ";
	echo "#header-en { font-size: 300%; display: block; transform: rotate(-5deg); font-weight: 700; } ";
	echo "</style>";
echo "</head>";
echo "<body>";
